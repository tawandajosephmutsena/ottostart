...
|-------|----------|----------|
| Governor limits exceeded | critical | See docs |
| SOQL injection vulnerability | high | See docs |
| Mixed DML operations | medium | See docs |
| Recursive triggers | high | See docs |
| Test data visibility | critical | See docs |
| Heap size exceeded | high | See docs |
| CPU time limit | high | See docs |
| Too many SOQL queries | critical | See docs |
